...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "html {\n  background-color: rgba(0, 0, 0, 0.5);\n}\n#field {\n  display: block;\n  margin: auto;\n  background-color: white;\n  border: 10px solid black;\n}\n\nh1 {\n  color: white;\n}\n\ndiv#control {\n  text-align: center;\n  margin: 10px;\n}\n\nbutton {\n  font-size: 40px;\n}\n\nspan#score {\n  display: inline-block;\n  width: 100px;\n  font-size: 30px;\n  text-align: right;\n  background-color: white;\n  padding: 4px;\n  margin: 4px;\n}\n\n#controls {\n  margin: 20px auto;\n  text-align: center;\n}\n#controls input {\n  font-size: 32px;\n}\n", "",{"version":3,"sources":["webpack://./src/style/style.css"],"names":[],"mappings":"AAAA;EACE,oCAAoC;AACtC;AACA;EACE,cAAc;EACd,YAAY;EACZ,uBAAuB;EACvB,wBAAwB;AAC1B;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,kBAAkB;EAClB,YAAY;AACd;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,qBAAqB;EACrB,YAAY;EACZ,eAAe;EACf,iBAAiB;EACjB,uBAAuB;EACvB,YAAY;EACZ,WAAW;AACb;;AAEA;EACE,iBAAiB;EACjB,kBAAkB;AACpB;AACA;EACE,eAAe;AACjB","sourcesContent":["html {\n  background-color: rgba(0, 0, 0, 0.5);\n}\n#field {\n  display: block;\n  margin: auto;\n  background-color: white;\n  border: 10px solid black;\n}\n\nh1 {\n  color: white;\n}\n\ndiv#control {\n  text-align: center;\n  margin: 10px;\n}\n\nbutton {\n  font-size: 40px;\n}\n\nspan#score {\n  display: inline-block;\n  width: 100px;\n  font-size: 30px;\n  text-align: right;\n  background-color: white;\n  padding: 4px;\n  margin: 4px;\n}\n\n#controls {\n  margin: 20px auto;\n  text-align: center;\n}\n#controls input {\n  font-size: 32px;\n}\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _Paddle_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Paddle.js */ "./src/scripts/Paddle.js");
...
class Ball extends _Mobile_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  constructor(x, y, theGame) {
    ...
    this.paddle = new _Paddle_js__WEBPACK_IMPORTED_MODULE_2__["default"](theGame , 20 , 550)
  }
...
var socket = (0,socket_io_client__WEBPACK_IMPORTED_MODULE_2__.io)('http://localhost:3000', { transports: ['websocket', 'polling', 'flashsocket'] });
...
class Game {
  ...
  constructor(canvas ) {
    ...
    this.paddle = new _Paddle_js__WEBPACK_IMPORTED_MODULE_1__["default"](this ,  this.canvas.width - 780 , this.canvas.height/2 -50 , 0) ; 
    this.paddle2 = new _Paddle_js__WEBPACK_IMPORTED_MODULE_1__["default"] (this , this.canvas.width - 45  , this.canvas.height / 2 - 50 , 0 )
  }
  ...
  moveAndDraw(event) {
    ...
    if (socket.connected()){
      this.paddle.drawScore(ctxt , "haha" , this.canvas.width/4 , 2*this.canvas.height/5 , "BLACK");
    }
...
const init = () => {
  const theField = document.getElementById("field");
  const theGame = new _Game_js__WEBPACK_IMPORTED_MODULE_0__["default"](theField);
  const thePaddle = new _Paddle_js__WEBPACK_IMPORTED_MODULE_1__["default"](theGame , 20 , 550);
